...
SECFL_PL = $(TOOL_DIR)/sign_sec_file_list.pl

DEAL_STDOUT_SIGN_IMAGE := 2>&1 | tee -a $(LOG_DIR)$(MTK_PROJECT_NAME)_sign-image.log
DEAL_STDOUT_SIGN_SECFL := 2>&1 | tee -a $(LOG_DIR)$(MTK_PROJECT_NAME)_sign-secfl.log
...
ifeq ($(MTK_DEPENDENCY_AUTO_CHECK), true)
	...
	$(hide) perl $(SECFL_PL) $(MTK_PROJECT_NAME) $(MTK_BASE_PROJECT) $(DEAL_STDOUT_SIGN_SECFL)
	$(hide) make -j24 snod
