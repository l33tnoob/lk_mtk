...
secroimage: 
	@perl $(SECRO_POST_SCRIPT) $(SECRO_CONFIG) $(MTK_PROJECT) $(MTK_PATH_CUSTOM) $(MTK_SEC_SECRO_AC_SUPPORT) $(INSTALLED_SECROIMAGE_TARGET) $(SECRO_TYPE) $(MTK_TARGET_PROJECT) $(OUT_DIR)
