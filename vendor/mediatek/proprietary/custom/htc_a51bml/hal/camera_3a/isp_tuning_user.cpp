...
)
{
    ...
    case MTK_CONTROL_ISP_EDGE_LOW:
        ...
        break;
/*HTC_START*/
    case MTK_CONTROL_ISP_EDGE_LOW3:
        i4Slider = -3; //Texture EE
        break;
    case MTK_CONTROL_ISP_EDGE_LOW2:
        i4Slider = -2; // Soft EE
        break;
    case MTK_CONTROL_ISP_EDGE_LOW1:
        i4Slider = -1; //Texture EE
        break;
    case MTK_CONTROL_ISP_EDGE_HIGH1:
        i4Slider = 1; // Soft EE
        break;
    case MTK_CONTROL_ISP_EDGE_HIGH2:
        i4Slider = 3; //Texture EE
        break;
    case MTK_CONTROL_ISP_EDGE_HIGH3:
        i4Slider = 5; //Texture EE
        break;
/*HTC_END*/
...
)
{
	MDOUBLE H_param[] = {-40, 0, 40};				// rotate degree H of 360
        //htc modify for image adjustment
       MDOUBLE S_param[] = {44.0/64, 49.0/64, 54.0/64, 59.0/64, 1, 69.0/64, 74.0/64, 79.0/64, 84.0/64};
		//{44.0/64, 1, 84.0/64} // gain = S
	MDOUBLE B_param[] = {-16*4, 0, 16*4};			// add B of 256
	//MDOUBLE C_param[] = { 54.0/64, 1, 74.0/64};
        //htc modify for image adjustment
      MDOUBLE C_param[] = { 54.0/64, 56.5/64, 59.0/64, 61.5/64, 1, 66.5/64, 69.0/64, 71.5/64, 74.0/64};
		//{ 54.0/64, 1, 74.0/64} // gain = C
