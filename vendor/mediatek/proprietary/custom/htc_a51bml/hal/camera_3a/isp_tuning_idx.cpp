...
#define LINK_ONE_SENSOR_SCENEs_ISOs(link, sensor)\
    ...
    LINK_ONE_SENSOR_ONE_SCENE_ISOs(link, sensor, MTK_CONTROL_SCENE_MODE_CSHOT);\
    LINK_ONE_SENSOR_ONE_SCENE_ISOs(link, sensor, MTK_CONTROL_SCENE_MODE_SWEEP_PANORAMA);
