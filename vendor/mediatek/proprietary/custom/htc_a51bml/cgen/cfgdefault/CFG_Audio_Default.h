...
#include SPH_COEFF_RECORD_MODE_DEFAULT_HEADER
#include SPH_COEFF_DMNR_DEFAULT_HEADER
#include SPH_COEFF_DMNR_HANDSFREE_DEFAULT_HEADER
#include AUDIO_HD_RECORD_CUSTOM_HEADER
#include AUDIO_ACF_DEFAULT_HEADER
#include AUDIO_HCF_DEFAULT_HEADER
#include AUDIO_EFFECT_DEFAULT_HEADER
#include AUDIO_GAIN_TABLE_DEFAULT_HEADER
#include AUDIO_VER1_VOLUME_CUSTOM_DEFAULT_HEADER
#include VOICE_RECOGNITION_CUSTOM_HEADER
#include AUDIO_AUDENH_CONTROL_OPTION_HEADER
#include AUDIO_VOIP_CUSTOM_HEADER
//#include AUDIO_ACFSUB_DEFAULT_HEADER
#include AUDIO_MUSIC_DRC_DEFAULT_HEADER
#include AUDIO_RINGTONE_DRC_DEFAULT_HEADER
#include SPH_COEFF_ANC_DEFAULT_HEADER
#include AUDIO_SPEAKER_MONITOR_CUSTOM_HEADER
#include SPH_COEFF_LPBK_DEFAULT_HEADER

#include SPH_COEFF_DEFAULT_HEADER
#include AUDIO_CUSTOM_HEADER
#include MED_AUDIO_DEFAULT_HEADER
#include AUDIO_VOLUME_CUSTOM_DEFAULT_HEADER
