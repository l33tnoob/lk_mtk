...
LID_BIT VER_LID(AP_CFG_REEB_HTC_BOARD_INFO_LID)
HTC_BOARD_INFO *CFG_FILE_HTC_BOARD_INFO_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_REEB_HTC_MFG_LID)
HTC_MFG *CFG_FILE_HTC_MFG_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_RDCL_FILE_FACTORY_RESERVED_LID)
FACTORY_RESERVED *CFG_FILE_FACTORY_RESERVED_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_RDCL_HTC_CAMERA_MFG1_LID)
HTC_CAMERA_MFG1_STRUCT *CFG_FILE_HTC_CAMERA_TOTAL
{
