...
//    AP_CFG_CUSTOM_FILE_CUSTOM2_LID,
    ...
    AP_CFG_REEB_HTC_BOARD_INFO_LID,
    AP_CFG_REEB_HTC_MFG_LID,
    AP_CFG_REEB_HTC_RESERVED_LID,
	AP_CFG_RDCL_FILE_FACTORY_RESERVED_LID,
    AP_CFG_RDCL_HTC_CAMERA_MFG1_LID,
...
/* verno of data items */
/* audio file version */
#define ACOUSTIC_VERSION                                        "018"
#define AP_CFG_RDCL_FILE_AUDIO_LID_VERNO			ACOUSTIC_VERSION

/* GPS file version */
#define AP_CFG_CUSTOM_FILE_GPS_LID_VERNO			"000"

/* audio acf file version */
#define AP_CFG_RDCL_FILE_AUDIO_COMPFLT_LID_VERNO	ACOUSTIC_VERSION

/* audio hcf file version */
#define AP_CFG_RDCL_FILE_HEADPHONE_COMPFLT_LID_VERNO	ACOUSTIC_VERSION
/* audio vibspk hcf file version */
#define AP_CFG_RDCL_FILE_VIBSPK_COMPFLT_LID_VERNO	ACOUSTIC_VERSION

/* audio effect file version */
#define AP_CFG_RDCL_FILE_AUDIO_EFFECT_LID_VERNO	ACOUSTIC_VERSION

/* audio med file version */
#define AP_CFG_RDCL_FILE_AUDIO_PARAM_MED_LID_VERNO  ACOUSTIC_VERSION

/* audio volume custom file version */
#define AP_CFG_RDCL_FILE_AUDIO_VOLUME_CUSTOM_LID_VERNO  ACOUSTIC_VERSION
#define AP_CFG_RDCL_FILE_AUDIO_VER1_VOLUME_CUSTOM_LID_VERNO  ACOUSTIC_VERSION

/* dual mic custom file version */
#define AP_CFG_RDCL_FILE_DUAL_MIC_CUSTOM_LID_VERNO  ACOUSTIC_VERSION

/* audio wb specch param custom file version */
#define AP_CFG_RDCL_FILE_AUDIO_WB_PARAM_LID_VERNO ACOUSTIC_VERSION

/* audio gain table custom file version */
#define AP_CFG_RDCL_FILE_AUDIO_GAIN_TABLE_LID_VERNO ACOUSTIC_VERSION

/* audio hd record par custom file version*/
#define AP_CFG_RDCL_FILE_AUDIO_HD_REC_PAR_LID_VERNO ACOUSTIC_VERSION
#define AP_CFG_RDCL_FILE_AUDIO_HD_REC_SCENE_LID_VERNO ACOUSTIC_VERSION
...
/* WIFI file version */
/* HTC_WIFI_START */
//** 2015-07-03 modify the default value by RF's request
#if 0
#define AP_CFG_RDEB_FILE_WIFI_LID_VERNO				"000"
#else
#define AP_CFG_RDEB_FILE_WIFI_LID_VERNO				"004"
#endif
/* HTC_WIFI_END */
...
#define AP_CFG_RDCL_FILE_AUDIO_MUSIC_DRC_LID_VERNO			ACOUSTIC_VERSION
#define AP_CFG_RDCL_FILE_AUDIO_RINGTONE_DRC_LID_VERNO			ACOUSTIC_VERSION

#define AP_CFG_RDCL_FILE_AUDIO_MAGI_CONFERENCE_LID_VERNO		ACOUSTIC_VERSION
#define AP_CFG_RDCL_FILE_AUDIO_HAC_PARAM_LID_VERNO			ACOUSTIC_VERSION
/* HTC_AUD_START */
#ifdef AP_CFG_RDCL_FILE_AUDIO_VOIP_PAR_LID_VERNO
#undef AP_CFG_RDCL_FILE_AUDIO_VOIP_PAR_LID_VERNO
#endif
#define AP_CFG_RDCL_FILE_AUDIO_VOIP_PAR_LID_VERNO ACOUSTIC_VERSION
/* HTC_AUD_END */
#define AP_CFG_RDCL_FILE_AUDIO_SPEECH_LPBK_PARAM_LID_VERNO		ACOUSTIC_VERSION
#define AP_CFG_RDCL_FILE_AUDIO_BT_GAIN_CUSTOM_LID_VERNO			ACOUSTIC_VERSION
#define AP_CFG_REEB_HTC_BOARD_INFO_LID_VERNO			"000"
#define AP_CFG_REEB_HTC_MFG_LID_VERNO			"000"
#define AP_CFG_REEB_HTC_RESERVED_LID_VERNO			"000"

#define AP_CFG_RDCL_FILE_FACTORY_RESERVED_LID_VERNO	"000"

#define AP_CFG_RDCL_HTC_CAMERA_MFG1_LID_VERNO			"000"
