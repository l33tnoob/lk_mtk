...
//HTC_AUD_START
        ...
        int subwoofer_getBufSize(void);
        void subwoofer_add_idx(int *idx);
        void subwoofer_clear_buffer(void);
        void subwoofer_reset_buffer(void);
        void subwoofer_release(void);
        void subwoofer_init(void);
        void updatesubwooferbufferlevel(void);
        char * subwooferRead(char *buffer, size_t bytes);
        void subwooferReset(void);
        char* sub_buffer[SUBWOOFER_BUF_MAX];
        int sub_buffer_in;
        int sub_buffer_out;
        bool sub_buffer_init;
        bool sub_buffer_error;
        bool sub_buf_start;
        int subwoofer_buffer_size;
#endif
//HTC_AUD_END
};
