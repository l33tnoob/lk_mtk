...
//HTC_AUD_START    For Camera landscape/portrait mode recording
#define AUDIO_DEVICE_CAM_RIGHT         "camera_right"
#define AUDIO_DEVICE_CAM_LEFT          "camera_left"
#define AUDIO_DEVICE_CAM_PORT          "camera_port"
#define AUDIO_DEVICE_CAM_MONO          "camera_mono"
//HTC_AUD_END
