...
/*RamDump*/
#define uistr_ramdump_mode "RAMDUMP Mode" 
#define uistr_ramdump "RAMDUMP"
#define uistr_info_ramdump_status "Status"
#define uistr_info_ramdump_init_fail "RAMDUMP Failure"
#define uistr_info_ramdump_timeout "RAMDUMP timed-out"
