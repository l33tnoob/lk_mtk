...
ifneq (true,$(LOCAL_UNINSTALLABLE_MODULE))
  ...
  ifneq ($(LOCAL_NO_STANDARD_LIBRARIES),true)
    #
    #Edit by U61 Nelson_Li, Requested by U11_Rhed_Jao
    #Do not create App subfolder for data/preload/ apps
    ifneq ($(LOCAL_MODULE), $(filter $(LOCAL_MODULE), $(HTC_USERDATA_APK)))
      my_module_path := $(my_module_path)/$(LOCAL_MODULE)
    endif
    #end by U61 Nelson_Li, Requested by U11_Rhed_Jao
    #
  endif
  endif
