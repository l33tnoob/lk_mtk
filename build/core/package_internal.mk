...
# modified by U6
# Start
ifeq ($(LOCAL_PACKAGE_NAME), $(filter $(LOCAL_PACKAGE_NAME), $(HTC_USERDATA_APK)))
...
# End For HTC's own Pre-OPT rule...

# A way to force every application do pre-opt, except under preload
