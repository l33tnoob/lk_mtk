...
# ---------------------------------------------------------------
# Setup HTC security debug flag. This flag depends on the HTC
# disclose flag. When the flag is zero, private data should
# not be built in.

ifeq ($(HTC_PROTECT_CONFIDENTIAL_FLAG),true)
COMMON_GLOBAL_CFLAGS += -DHTC_SECURITY_DEBUG_FLAG=0
COMMON_RELEASE_CFLAGS += -DHTC_SECURITY_DEBUG_FLAG=0
COMMON_GLOBAL_CPPFLAGS += -DHTC_SECURITY_DEBUG_FLAG=0
COMMON_RELEASE_CPPFLAGS += -DHTC_SECURITY_DEBUG_FLAG=0
else
COMMON_GLOBAL_CFLAGS += -DHTC_SECURITY_DEBUG_FLAG=1
COMMON_RELEASE_CFLAGS += -DHTC_SECURITY_DEBUG_FLAG=1
COMMON_GLOBAL_CPPFLAGS += -DHTC_SECURITY_DEBUG_FLAG=1
COMMON_RELEASE_CPPFLAGS += -DHTC_SECURITY_DEBUG_FLAG=1
endif
...
CCC_CERT_JAR := external/HtcBuildFlag/build_tools/certificategenerator-linux-64.jar
#[CCC_CERT] Nelson_Li end
