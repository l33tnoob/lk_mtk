...
ifdef built_odex
#++[Optimization][bowen_lai][2015/9/9][ART] config compiler flag by module
...
#++[Optimization][bowen_lai][2014/12/11][ART] Implement Hybrid Mode
ifeq ($(WITH_ART_HYBRID_MODE),true)
  ifeq (,$(findstring --compiler-filter,$(LOCAL_DEX_PREOPT_FLAGS)))
    LOCAL_DEX_PREOPT_FLAGS += --compiler-filter=interpret-only
  else
    $(info override hybrid mode $(LOCAL_MODULE):$(LOCAL_DEX_PREOPT_FLAGS))
  endif
endif
#--[Optimization][bowen_lai][2014/12/11][ART] Implement Hybrid Mode
