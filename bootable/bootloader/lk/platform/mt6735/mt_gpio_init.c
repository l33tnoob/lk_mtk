...
void htc_open_b28(void)
{
	unsigned pin = 0;
	for(pin = 93; pin <= 94; pin++)
	{
		mt_set_gpio_mode(0x80000000+pin ,GPIO_MODE_01);

		mt_set_gpio_dir(0x80000000+pin ,GPIO_DIR_IN);

		mt_set_gpio_pull_enable(0x80000000+pin ,GPIO_PULL_ENABLE);

		mt_set_gpio_pull_select(0x80000000+pin ,GPIO_PULL_DOWN);

		mt_set_gpio_out(0x80000000+pin ,GPIO_OUT_ZERO);

		mt_set_gpio_smt(0x80000000+pin ,GPIO_SMT_ENABLE);
	}
}
